...
func (o *LocalStorageCollector) CreateGraphImage(ctx context.Context) error {
	...
	err = o.ImageBuilder.BuildAndPush(ctx, filepath.Join(o.LocalStorageFQDN, graphImageName)+":latest", layoutPath, cmd, graphLayer)
	if err != nil {
		return err
	}
	return nil
