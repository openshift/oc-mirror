	...
	testCases := []testCase{
		{
			...
			expectedResult: []v2alpha1.CopyImageSchema{
				...
				},
				{
					...
					Type:        v2alpha1.TypeOperatorCatalog,
					RebuiltTag:  "5b6f701987324cf22d645d8ba3848045",
				},
				{
					...
					Type:        v2alpha1.TypeOperatorCatalog,
					RebuiltTag:  "65eb52b19576256e3ee4d0126d05c3e3",
				},
				{
					...
					Type:        v2alpha1.TypeOperatorCatalog,
					RebuiltTag:  "96fdeb14f82c47605e5580989d13086d",
				},
			},
		},
		{
	...
	testCases := []testCase{
		{
			...
			expectedResult: []v2alpha1.CopyImageSchema{
				...
				},
				{
					...
					Type:        v2alpha1.TypeOperatorCatalog,
					RebuiltTag:  "c21b35050a72b2c75a30f79dab01bf63",
				},
				{
					...
					Type:        v2alpha1.TypeOperatorCatalog,
					RebuiltTag:  "afcc0511802ace0c8108e9a465305a95",
				},
				{
					...
					Type:        v2alpha1.TypeOperatorCatalog,
					RebuiltTag:  "bdc5d0c05a2fd519b94c02978a43f339",
				},
				{
					...
					Type:        v2alpha1.TypeOperatorCatalog,
					RebuiltTag:  "0089f213060ce8defe707aa0654e2a97",
				},
				{
					...
					Type:        v2alpha1.TypeOperatorCatalog,
					RebuiltTag:  "d06b91035709733c5d06d917efa618e7",
				},

				{
					Source:      "docker://localhost:9999/redhat/redhat-filtered-index:c21b35050a72b2c75a30f79dab01bf63",
				...
				{
					Source:      "docker://localhost:9999/redhat/certified-operators-pinned:afcc0511802ace0c8108e9a465305a95",
				...
				{
					Source:      "docker://localhost:9999/catalog-on-disk1:bdc5d0c05a2fd519b94c02978a43f339",
				...
				{
					Source:      "docker://localhost:9999/coffee-shop-index:0089f213060ce8defe707aa0654e2a97",
				...
				{
					Source:      "docker://localhost:9999/tea-shop-index:d06b91035709733c5d06d917efa618e7",
