	...
	testCases := []testCase{
		{
			...
			expectedResult: []v2alpha1.CopyImageSchema{
				...
				{
					Source:      "docker://redhat-operators:v4.7",
					Destination: "docker://localhost:9999/redhat-operators:sha256-f30638f60452062aba36a26ee6c036feead2f03b28f2c47f2b0a991e41baebea",
					Origin:      "docker://redhat-operators:v4.7",
					Type:        v2alpha1.TypeOperatorCatalog,
				},
				{
				...
				{
					Source:      "docker://certified-operators:v4.7",
					Destination: "docker://localhost:9999/certified-operators:sha256-f30638f60452062aba36a26ee6c036feead2f03b28f2c47f2b0a991e41baebea",
					Origin:      "docker://certified-operators:v4.7",
					Type:        v2alpha1.TypeOperatorCatalog,
					RebuiltTag:  "70eb0b2116707316c6130de415ceeb69",
				},
				...
				{
					Source:      "docker://community-operators:v4.7",
					Destination: "docker://localhost:9999/community-operators:sha256-f30638f60452062aba36a26ee6c036feead2f03b28f2c47f2b0a991e41baebea",
					Origin:      "docker://community-operators:v4.7",
					Type:        v2alpha1.TypeOperatorCatalog,
					RebuiltTag:  "ac8e314872a499f2c6edb0616489c628",
				},
				...
				{
					Source:      "oci://" + filepath.Join(testDir, "simple-test-bundle"),
					Destination: "docker://localhost:9999/simple-test-bundle:sha256-f30638f60452062aba36a26ee6c036feead2f03b28f2c47f2b0a991e41baebea",
					Origin:      "oci://" + filepath.Join(testDir, "simple-test-bundle"),
					Type:        v2alpha1.TypeOperatorCatalog,
					RebuiltTag:  "eaf28fd0a9f205e44fb52a8b0bd8e678",
				},
		...
		},
		{
			...
			expectedResult: []v2alpha1.CopyImageSchema{
				...
				{
					Source:      "oci://" + filepath.Join(testDir, "simple-test-bundle"),
					Destination: "docker://localhost:9999/test-catalog:sha256-f30638f60452062aba36a26ee6c036feead2f03b28f2c47f2b0a991e41baebea",
					Origin:      "oci://" + filepath.Join(testDir, "simple-test-bundle"),
					Type:        v2alpha1.TypeOperatorCatalog,
					RebuiltTag:  "eaf28fd0a9f205e44fb52a8b0bd8e678",
				},
		...
		},
		{
			...
			expectedResult: []v2alpha1.CopyImageSchema{
				...
				{
					Source:      "docker://certified-operators:v4.7",
					Destination: "docker://localhost:9999/test-namespace/test-catalog:sha256-f30638f60452062aba36a26ee6c036feead2f03b28f2c47f2b0a991e41baebea",
					Origin:      "docker://certified-operators:v4.7",
					Type:        v2alpha1.TypeOperatorCatalog,
					RebuiltTag:  "70eb0b2116707316c6130de415ceeb69",
				},
