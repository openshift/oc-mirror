...
type catalogHandlerInterface interface {
	...
	getRelatedImagesFromCatalog(dc *declcfg.DeclarativeConfig, iscCatalogFilter v2alpha1.Operator, copyImageSchemaMap *v2alpha1.CopyImageSchemaMap) (map[string][]v2alpha1.RelatedImage, error)
