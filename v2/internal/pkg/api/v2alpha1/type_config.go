...
type Operator struct {
	...
	// RFE-5555 and OCPSTRAT-1842 add field to override the CatalogSource metadata name
	OverrideCatalogSourceName string `json:"overrideCatalogSourceName,omitempty"`
}
