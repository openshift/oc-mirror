...
func (o *ReleaseOptions) getChannelDownloads(ctx context.Context, c cincinnati.Client, lastChannels []v1alpha1.ReleaseChannel, channel v1alpha1.ReleaseChannel, arch string) (downloads, error) {
...
func (o *ReleaseOptions) getCrossChannelDownloads(ctx context.Context, arch string, channels []v1alpha1.ReleaseChannel) (downloads, error) {
	...
	firstCh, first, err := cincinnati.FindRelease(channels, true)
	if err != nil {
		return downloads{}, fmt.Errorf("failed to find minimum release version: %v", err)
	}
	lastCh, last, err := cincinnati.FindRelease(channels, false)
	if err != nil {
