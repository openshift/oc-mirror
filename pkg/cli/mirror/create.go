...
// 	var processImageIndex func(idimageIndexx v1.ImageIndex) (v1.ImageIndex, error)
// 	processImageIndex = func(imageIndex v1.ImageIndex) (v1.ImageIndex, error) {
// 		// get the manifest from the image index
...
// 	// get the image index
// 	imageIndex, err := layout.ImageIndexFromPath(v1alpha2.TrimProtocol(operator.Catalog))
// 	if err != nil {
// 		return err
// 	}

// 	processImageIndex(imageIndex)

// 	catalogContentsDir := filepath.Join(artifactsFolderName, ctlg.Ref.Name)
// 	extractDeclarativeConfigFromImage(path, catalogContentsDir)
