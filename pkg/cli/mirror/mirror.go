...
func buildV2Cmd() *cobra.Command {
	fmt.Println("--v2 flag identified, flow redirected to the oc-mirror v2 version. PLEASE DON'T USE it. V2 is still under development and it is not production ready.")
