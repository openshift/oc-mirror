...
function full_catalog_with_digest() {
    workflow_full imageset-config-full-digest.yaml "test-catalog-latest${CATALOG_ARCH}" -c="--source-use-http --source-skip-tls"
...
function headsonly_diff () {
    workflow_full imageset-config-headsonly.yaml "test-catalog-latest${CATALOG_ARCH}" --diff -c="--source-use-http --source-skip-tls"
    check_bundles localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:test-catalog-latest${CATALOG_ARCH} \
    "bar.v0.1.0 bar.v0.2.0 bar.v1.0.0 baz.v1.1.0 foo.v0.3.1" \
    localhost.localdomain:${REGISTRY_DISCONN_PORT}

    workflow_diff imageset-config-headsonly.yaml "test-catalog-diff${CATALOG_ARCH}" -c="--source-use-http --source-skip-tls"
    check_bundles localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:test-catalog-latest${CATALOG_ARCH} \
...
function headsonly_diff_with_target () {
    workflow_full imageset-config-headsonly-newtarget.yaml "test-catalog-latest${CATALOG_ARCH}" --diff -c="--source-use-http --source-skip-tls"
    # shellcheck disable=SC2086
    check_bundles localhost.localdomain:"${REGISTRY_DISCONN_PORT}"/"${CATALOGORG}"/${TARGET_CATALOG_NAME}:${TARGET_CATALOG_TAG} \
    "bar.v0.1.0 bar.v0.2.0 bar.v1.0.0 baz.v1.1.0 foo.v0.3.1" \
    localhost.localdomain:${REGISTRY_DISCONN_PORT}

    workflow_diff imageset-config-headsonly-newtarget.yaml "test-catalog-diff${CATALOG_ARCH}" -c="--source-use-http --source-skip-tls"
    check_bundles localhost.localdomain:"${REGISTRY_DISCONN_PORT}"/"${CATALOGORG}"/"${TARGET_CATALOG_NAME}":"${TARGET_CATALOG_TAG}" \
    "bar.v0.1.0 bar.v0.2.0 bar.v1.0.0 baz.v1.1.0 foo.v0.3.0 foo.v0.3.1 foo.v0.3.2" \
    localhost.localdomain:"${REGISTRY_DISCONN_PORT}"
}
...
function pruned_catalogs() {
    workflow_full imageset-config-headsonly.yaml "test-catalog-prune${CATALOG_ARCH}" --diff -c="--source-use-http --source-skip-tls"
    check_bundles localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:test-catalog-latest${CATALOG_ARCH} \
    "bar.v0.1.0 foo.v0.1.1" \
    localhost.localdomain:${REGISTRY_DISCONN_PORT}
    check_image_exists "localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:86fa1b12"

    workflow_diff imageset-config-headsonly.yaml "test-catalog-prune-diff${CATALOG_ARCH}" -c="--source-use-http --source-skip-tls"
    check_bundles localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:test-catalog-latest${CATALOG_ARCH} \
...
function pruned_catalogs_with_target() {
    workflow_full imageset-config-headsonly-newtarget.yaml "test-catalog-prune${CATALOG_ARCH}" --diff -c="--source-use-http --source-skip-tls"
    check_bundles localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGORG}/${TARGET_CATALOG_NAME}:${TARGET_CATALOG_TAG} \
    "bar.v0.1.0 foo.v0.1.1" \
    localhost.localdomain:${REGISTRY_DISCONN_PORT}
    check_image_exists "localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:86fa1b12"

    workflow_diff imageset-config-headsonly-newtarget.yaml "test-catalog-prune-diff${CATALOG_ARCH}" -c="--source-use-http --source-skip-tls"
    check_bundles localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGORG}/${TARGET_CATALOG_NAME}:${TARGET_CATALOG_TAG} \
    "bar.v0.1.0 foo.v0.2.0" \
    localhost.localdomain:${REGISTRY_DISCONN_PORT}
    check_image_removed "localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:86fa1b12"
...
function pruned_catalogs_with_include() {
    workflow_full imageset-config-filter-multi-prune.yaml "test-catalog-prune${CATALOG_ARCH}" --diff -c="--source-use-http --source-skip-tls"
    check_bundles localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:test-catalog-latest${CATALOG_ARCH} \
    "bar.v0.1.0 foo.v0.1.1" \
    localhost.localdomain:${REGISTRY_DISCONN_PORT}
    check_image_exists "localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:86fa1b12"

    workflow_diff imageset-config-filter-multi-prune.yaml "test-catalog-prune-diff${CATALOG_ARCH}" -c="--source-use-http --source-skip-tls"
    check_bundles localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:test-catalog-latest${CATALOG_ARCH} \
    "bar.v0.1.0 foo.v0.2.0" \
    localhost.localdomain:${REGISTRY_DISCONN_PORT}
    check_image_removed "localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:86fa1b12"
...
function pruned_catalogs_mirror_to_mirror() {
    workflow_mirror2mirror imageset-config-headsonly.yaml "test-catalog-prune${CATALOG_ARCH}" -c="--source-use-http --source-skip-tls"
    check_bundles localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:test-catalog-latest${CATALOG_ARCH} \
    "bar.v0.1.0 foo.v0.1.1" \
    localhost.localdomain:${REGISTRY_DISCONN_PORT}
    check_image_exists "localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:86fa1b12"

    workflow_mirror2mirror imageset-config-headsonly.yaml "test-catalog-prune-diff${CATALOG_ARCH}" -c="--source-use-http --source-skip-tls"
    check_bundles localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:test-catalog-latest${CATALOG_ARCH} \
    "bar.v0.1.0 foo.v0.2.0" \
    localhost.localdomain:${REGISTRY_DISCONN_PORT}
    check_image_removed "localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:86fa1b12"
...
function registry_backend () {
    workflow_full imageset-config-headsonly-backend-registry.yaml "test-catalog-latest${CATALOG_ARCH}" --diff -c="--source-use-http --source-skip-tls"
    check_bundles localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:test-catalog-latest${CATALOG_ARCH} \
    "bar.v0.1.0 bar.v0.2.0 bar.v1.0.0 baz.v1.1.0 foo.v0.3.1" \
    localhost.localdomain:${REGISTRY_DISCONN_PORT}

    workflow_diff imageset-config-headsonly-backend-registry.yaml "test-catalog-diff${CATALOG_ARCH}" -c="--source-use-http --source-skip-tls"
    check_bundles localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:test-catalog-latest${CATALOG_ARCH} \
    "bar.v0.1.0 bar.v0.2.0 bar.v1.0.0 baz.v1.1.0 foo.v0.3.0 foo.v0.3.1 foo.v0.3.2" \
    localhost.localdomain:${REGISTRY_DISCONN_PORT}
}
...
function mirror_to_mirror() {
    workflow_mirror2mirror imageset-config-headsonly.yaml "test-catalog-latest${CATALOG_ARCH}" -c="--source-use-http --source-skip-tls"
    check_bundles localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:test-catalog-latest${CATALOG_ARCH} \
    "bar.v0.1.0 bar.v0.2.0 bar.v1.0.0 baz.v1.1.0 foo.v0.3.1" \
    localhost.localdomain:${REGISTRY_DISCONN_PORT}
}
...
function mirror_to_mirror_nostorage() {
    workflow_mirror2mirror imageset-config-full.yaml "test-catalog-latest${CATALOG_ARCH}" -c="--source-use-http --source-skip-tls"
    check_bundles localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:test-catalog-latest${CATALOG_ARCH} \
    "bar.v0.1.0 bar.v0.2.0 bar.v1.0.0 baz.v1.0.0 baz.v1.0.1 baz.v1.1.0 foo.v0.1.0 foo.v0.2.0 foo.v0.3.0 foo.v0.3.1" \
    localhost.localdomain:${REGISTRY_DISCONN_PORT}
}
...
function custom_namespace {
    workflow_full imageset-config-headsonly-backend-registry.yaml "test-catalog-latest${CATALOG_ARCH}" --diff -n="custom" -c="--source-use-http --source-skip-tls"
    ...
    workflow_diff imageset-config-headsonly-backend-registry.yaml "test-catalog-diff${CATALOG_ARCH}" -n="custom" -c="--source-use-http --source-skip-tls"
    check_bundles "localhost.localdomain:${REGISTRY_DISCONN_PORT}/custom/${CATALOGNAMESPACE}:test-catalog-latest" \
    "bar.v0.1.0 bar.v0.2.0 bar.v1.0.0 baz.v1.1.0 foo.v0.3.0 foo.v0.3.1 foo.v0.3.2" \
    localhost.localdomain:${REGISTRY_DISCONN_PORT} "custom"
}
...
function package_filtering {
    workflow_full imageset-config-filter.yaml "test-catalog-latest${CATALOG_ARCH}" --diff -c="--source-use-http --source-skip-tls"
    ...
    workflow_diff imageset-config-filter-multi.yaml "test-catalog-diff${CATALOG_ARCH}" -c="--source-use-http --source-skip-tls"
    check_bundles "localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:test-catalog-latest" \
...
function single_version () {
    workflow_full imageset-config-filter-single.yaml "test-catalog-latest${CATALOG_ARCH}" -c="--source-use-http --source-skip-tls"
    check_bundles localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:test-catalog-latest${CATALOG_ARCH} \
    "baz.v1.0.1" \
    localhost.localdomain:${REGISTRY_DISCONN_PORT}
}
...
function version_range () {
    workflow_full imageset-config-filter-range.yaml "test-catalog-latest${CATALOG_ARCH}" -c="--source-use-http --source-skip-tls"
    check_bundles localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:test-catalog-latest${CATALOG_ARCH} \
...
function max_version () {
    workflow_full imageset-config-filter-max.yaml "test-catalog-latest${CATALOG_ARCH}" -c="--source-use-http --source-skip-tls"
    check_bundles localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:test-catalog-latest${CATALOG_ARCH} \
...
# Test skip deps
function skip_deps {
    workflow_full imageset-config-skip-deps.yaml "test-catalog-latest${CATALOG_ARCH}" --diff -c="--source-use-http --source-skip-tls"
    check_bundles "localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:test-catalog-latest" \
...
function no_updates_exist {
    workflow_no_updates imageset-config-headsonly.yaml "test-catalog-latest${CATALOG_ARCH}" --diff -c="--source-use-http --source-skip-tls"
    check_bundles localhost.localdomain:${REGISTRY_DISCONN_PORT}/${CATALOGNAMESPACE}:test-catalog-latest${CATALOG_ARCH} \
    "bar.v0.1.0 bar.v0.2.0 bar.v1.0.0 baz.v1.1.0 foo.v0.3.1" \
    localhost.localdomain:${REGISTRY_DISCONN_PORT}
...
function m2m_oci_catalog {
    ...
    check_bundles localhost.localdomain:${REGISTRY_DISCONN_PORT}/redhatgov/oc-mirror-dev:test-catalog-latest${CATALOG_ARCH} \
    "baz.v1.0.1" \
    localhost.localdomain:${REGISTRY_DISCONN_PORT}
}
